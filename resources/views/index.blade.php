        ...
        <div class="row">
            ...
            <div class="column">
                 <a href="BMW 3 series.html">
                  <img class="demo cursor" src="{{asset('photo/home3series.png')}}" style="width: 240px; margin-top: 15px;margin-left:-15px;" height="190px"  onclick="currentSlide(1)"  alt="The Woods">                
                 </a>                
             </div>
