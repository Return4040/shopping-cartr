...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="images/BMW 5 series.jpg" class="img-fluid rounded-circle" alt="100" width="100"
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card border-0">
                <div class="row">
                    <div class="col-md-6"><img src="images/BMW 5 series.jpg" alt="" class="img-fluid" width="100%">
                    </div> 
                    <div class="col-md-6">
                        ...
                        <form action="BMW 5 series checkout">
