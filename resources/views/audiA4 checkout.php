...
<html lang="en">
  <head>
    ...
    <script>
      ...
      function cal(){
        ...
        total=subtotal+tax;
        if(subtotal>100000){
          document.getElementById("extradiscount").innerHTML="Discount RM10000"
          total=total-1000;
  ...
  <body onload="myFunction()">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="photo/audiA4.jpeg" class="img-fluid rounded-circle" alt="100" width="100">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <tr>
                    ...
                    <td><img src="photo/audiA4.jpeg" width="100" alt=""></td>
                    <td style="padding: 10px;">RM240,000  <input type="hidden" name="price[]" id="price[]" value="240000"></td>
