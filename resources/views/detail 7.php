...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="images/honda city.jpg" class="img-fluid rounded-circle" alt="100" width="100"></image>
        ...
        <div class="col-md-1"></div>
          ...
          <div class="col-md-8">
            ...
            <div class="card border-0">
                <div class="row">
                    <div class="col-md-6"><img src="images/honda city.jpg" alt="" class="img-fluid">
                    </div> 
                    <div class="col-md-6">
