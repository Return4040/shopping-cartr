...
function showSlides() {
  ...
  setTimeout(showSlides, 2000); // Change image every 2 seconds
        ...
        <div class="row">
            ...
            <div class="column">
                 <a href="{{ url('BMW 3 series')}}">
                  <img class="demo cursor" src="{{ asset('images/home3series.png')}}" style="width: 240px; margin-top: 15px;margin-left:-15px;" height="190px"  onclick="currentSlide(1)"  alt="The Woods">                
                 </a>                
             </div>
             
              <div class="column">
                <a href="{{ url('BMW 5 series')}}">
                  <img class="demo cursor" src="{{ asset('images/home5series.png')}}" style="width: 230px; margin-top: 30px; margin-left:-15px;" height="130px" onclick="currentSlide(1)" alt="The Woods">                
                </a>   
              </div>

             <div class="column">
                <a href="{{ url('audiA4')}}">
                  <img class="demo cursor" src="{{ asset('images/homeA4.png')}}" style="width: 230px; margin-top: 20px; margin-right:-20px ;" height="160px" onclick="currentSlide(1)" alt="The Woods">                
                </a>           
            </div>
          
            <div class="column">
                 <a href="https://m.honda.com.my/graphic/models/civic/2016civic/360_exterior/civic04.png">
                  <img class="demo cursor" src="{{ asset('images/homei8.png')}}"style="margin-top:40px;width: 230px;" height="120px" onclick="currentSlide(1)" alt="The Woods">                
                 </a>           
            </div>
            <div class="column">
                 <a href="https://m.honda.com.my/graphic/models/civic/2016civic/360_exterior/civic04.png">
