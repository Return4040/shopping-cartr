  ...
  <body>
    ...
    <div class="container-fluid" >
        <div class="row">
             <div class="col-md-2">
                <ul class="list-group">
                  <li class="list-group-item">Audi<img src="photo/audilogo.png" width="50%" style="padding: 20px;"></li>
                  <li class="list-group-item">Honda<img src="photo/honda.png" width="35%" style="padding: 5px;"></li>
                  <li class="list-group-item">BMW<img src="photo/bmlogo.png" width="40%" style="padding: 10px;"></li>
                    ...
                    <div class="row">
                        ...
                        <div class="card h-80">
                          <div class="card-body">
                                ...
                                <img src="photo/honda city.jpg" alt="" class="img-fluid" width="100%"></a>                             
                                  <div class="card-heading ">RM92,000</div>
                                  <form action="detail 7 checkout.html">
                        ...
                        <div class="col-sm-4">
                             <div class="card h-80">
                               <div class="card-body">
                                     ...
                                     <img src="photo/honda civic type R.jpg" alt="" class="img-fluid" width="100%"></a>
                                     <div class="card-heading ">RM300.000</div>
                                     <form action="detail 8 checkout.html">
                                      <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                     </form>
                            ...
                            <div class="card h-100">
                              <div class="card-body">
                                     ...
                                     <a href="detail 9.html">
                                      <img src="photo/honda accord.png" alt="" class="img-fluid" width="75%"></a>
                                      <div class="card-heading ">RM170,000</div>
                                      <form action="detail 9 checkout.html">
                                      <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                      </form>
                                  </div>  
                             </div>                             
                          ...
                          <div class="col-sm-4">
                              <div class="card h-100">
                                <div class="card-body">
                                       ...
                                       <a href="audiA4.html">
                                        <img src="photo/audiA4.jpeg" alt="" class="img-fluid" width="80%" height="100px"></a>
                                        <div class="card-heading ">RM240.000</div>
                                        <form action="audiA4 checkout.html">
                                        <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                        </form>
                                    </div>  
                               </div>                             
                            ...
                            <div class="col-sm-4">
                                <div class="card h-100">
                                  <div class="card-body">
                                         ...
                                         <a href="audiA6.html">
                                          <img src="photo\audiA6.jpg" alt="" class="img-fluid" width="100%"></a>
                                          <div class="card-heading ">RM550.000</div>
                                          <form action="audiA6 checkout.html">
                                          <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                          </form>
                                      </div>  
                                 </div>                             
                              ...
                              <div class="col-sm-4">
                                  <div class="card h-100">
                                    <div class="card-body">
                                           ...
                                           <a href="audiTT.html">
                                            <img src="photo/audiTT.jpg" alt="" class="img-fluid" width="90%"></a>
                                            <div class="card-heading ">RM270,000</div>
                                            <form action="audiTT checkout.html">
                                            <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                            </form>
                                        </div>  
                                   </div>                             
                                    ...
                                    <div class="card h-100">
                                      <div class="card-body">
                                             ...
                                             <a href="BMW 3 series.html">
                                              <img src="photo/BMW 3 series.jpg" alt="" class="img-fluid"></a>
                                              <div clascars="card-heading ">RM328,800</div>
                                              <form action="BMW 3 series checkout.html">
                                              <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                              </form>
                                          </div>  
                                     </div>                             
                                      ...
                                      <div class="card h-100">
                                        <div class="card-body">
                                               ...
                                               <a href="BMW 5 series.html">
                                                <img src="photo/BMW 5 series.jpg" alt="" class="img-fluid" width="90%" ></a>
                                                <div class="card-heading ">RM 330,800</div>
                                                <form action="BMW 5 series checkout.html">
                                                <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                                </form>
                                            </div>  
                                       </div>                             
                                    ...
                                    <div class="col-sm-4">
                                        <div class="card h-100">
                                          <div class="card-body">
                                                 ...
                                                 <a href="BMW i8.html">
                                                  <img src="photo/BMW i8.jpg" alt="" class="img-fluid"></a>
                                                  <div class="card-heading ">RM1,310,800</div>
                                                  <form action="BMW i8 checkout.html">
                                                  <button style=float:right class="btn btn-danger btn-xs">Add to Cart</button>
                                                  </form>
                                              </div>  
                                         </div>                             
