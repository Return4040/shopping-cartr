...
<html lang="en">
  ...
  <body onload="myFunction()">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="photo/BMW 5 series.jpg" class="img-fluid rounded-circle" alt="100" width="100">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <tr>
                    ...
                    <td><img src="photo/BMW 5 series.jpg" width="100" alt=""></td>
                    <td>RM 330,800 <input type="hidden" name="price[]" id="price[]" value="330800"></td>
