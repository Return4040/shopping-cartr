...
<html lang="en">
  ...
  <body onload="myFunction()">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="image/yrgorgor.jpg" class="img-fluid rounded-circle" alt="100" width="100">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <tr>
                    ...
                    <td><img src="image/06.png" width="80" alt=""> Best Gaming Computer</td>
                    <td>RM7000 <input type="hidden" name="price[]" id="price[]" value="7000"></td>
                ...
                <tr>
                    <td><input type="checkbox" name="item[]" value=""></td>
                    <td><img src="image/gg.png" width="80" alt=""> HTML Lesson</td>
                    <td>RM8000 <input type="hidden" name="price[]" id="price[]" value="8000"></td>
