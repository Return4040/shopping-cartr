...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="photo/honda city.jpg" class="img-fluid rounded-circle" alt="100" width="100"></image>
        ...
        <div class="col-md-1"></div>
          ...
          <div class="col-md-8">
            ...
            <div class="card border-0">
                <div class="row">
                    <div class="col-md-6"><img src="photo/honda city.jpg" alt="" class="img-fluid">
                    </div> 
                    <div class="col-md-6">
                        <h5 class="card-title">Honda City</h5>
                        <p>It's stylish, gives good mileage and is a value for money car. The only thing that should be improved is the diesel engine noise. A little noisy.                               
                        </p>
