...
<html lang="en">
  ...
  <body onload="myFunction()">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="photo/honda civic type R.jpg" class="img-fluid rounded-circle" alt="100" width="100">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <tr>
                    ...
                    <td><img src="photo/honda civic type R.jpg" width="100" alt=""> </td>
                    <td>RM300,000 <input type="hidden" name="price[]" id="price[]" value="300000"></td>
                    <td><input type="number" value="1" min="1" max="10" size="4" name="quantity[]" id="quantity[]"></td>
