...
<html lang="en">
  ...
  <body onload="myFunction()">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
        <image src="photo/audiTT.jpg" class="img-fluid rounded-circle" alt="100" width="100">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <tr>
                    ...
                    <td><img src="photo/audiTT.jpg" width="110" alt=""></td>
                    <td style="padding: 10px;">RM270,000  <input type="hidden" name="price[]" id="price[]" value="270000"></td>
